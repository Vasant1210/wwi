import { GuidedTour, TourStep, OrientationConfiguration, Orientation } from 'ngx-guided-tour';

export class XTour implements GuidedTour {
  /** Identifier for tour */
  tourId: string;
...
export class XTourSteps implements TourStep {
